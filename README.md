...
* **Calculadora de Consumo de Energia** ([Abrir no Navegador]([calculadora.html](https://app.ofabio.com.br))) * Uma calculadora simples utilizando um slider para simular o custo mensal de energia com base no consumo (80 a 800 kWh), a um custo fixo de R$ 0,64/kWh. Estilizada com base em um Design System ([Kaizen DS](https://designsystem.ofabio.com.br)).
